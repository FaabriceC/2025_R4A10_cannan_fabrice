...
interface Update<T> {
    update(id: ID, entry: T): Promise<T>;
}
...
class SQLStudentRepository implements StudentRepository {
    ...
    async findOne(id: ID): Promise<Student | null> {
        return null;
    }
    
    async create(entry: Student): Promise<Student> {
        return entry;
    }
    
    async update(id: ID, entry: Student): Promise<Student> {
        return entry;
    }
...
class SQLCourseRepository implements CourseRepository {
    ...
    async findOne(id: ID): Promise<Course | null> {
        return null;
    }
    
    async create(entry: Course): Promise<Course> {
        return entry;
    }
    
    async update(id: ID, entry: Course): Promise<Course> {
        return entry;
    }
}
